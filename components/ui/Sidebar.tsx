  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
        <p className="px-3 mb-2 text-[10px] font-mono uppercase tracking-widest text-sidebar-text opacity-60">
          Módulos
        </p>
        {navItems
      ...
      <div className="px-3 pb-4 border-t border-sidebar-border pt-4">
        <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg mb-2 bg-sidebar-hover">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[10px] text-sidebar-text font-mono">{user.rol}</p>
          </div>
        </div>
        <button
          onClick={logout}
